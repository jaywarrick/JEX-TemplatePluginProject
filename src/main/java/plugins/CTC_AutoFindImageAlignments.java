...
@Plugin(
		...
		name="CTC - Auto-Find Image Alignments",
		menuPath="CTC Toolbox", // TODO
		visible=true,
...
public class CTC_AutoFindImageAlignments extends JEXPlugin {

	public static final int LtoR = 0, TtoB = 1;
	
	public CTC_AutoFindImageAlignments()
	{}

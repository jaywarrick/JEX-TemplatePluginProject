 ...
 * 
 */
public class CTC_JEX_ImageTools_Stitch_Coord extends JEXCrunchable {
	
	public CTC_JEX_ImageTools_Stitch_Coord()
	{}
	...
	public static File stitch(JEXEntry entry, JEXData imageData, List<DimensionMap> imageDimMaps, PointList imageDisplacements, double scale, boolean normalize, double multiplier, int bits)
	{
		...
		while (itr.hasNext() && itrXY.hasNext())
		{
			...
			Logs.log("Getting file " + ImageReader.readObjectToImagePath(imageData, map) + " in entry " + entry.getTrayX() + "," + entry.getTrayY() + " for dim " + map.toString(), 0, CTC_JEX_ImageTools_Stitch_Coord.class);
